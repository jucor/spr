...
type GitHubInterface interface {
	...
	//
	// Used unconditionally by spr's update flow to identify local change
	// IDs that should be `jj abandon`-ed before rebase, avoiding the
	// cascade-orphan conflict cascade.
