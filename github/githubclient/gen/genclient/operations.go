...
func (c *gqlclient) PullRequestsWithMergeQueue(ctx context.Context,
	...
	var pullRequestsWithMergeQueueOperation string = `
	query PullRequestsWithMergeQueue ($repo_owner: String!, $repo_name: String!) {
	viewer {
		login
		pullRequests(first: 100, states: [OPEN]) {
			nodes {
...
`
	...
	gqlreq := &client.GQLRequest{
		OperationName: "PullRequestsWithMergeQueue",
		Query:         pullRequestsWithMergeQueueOperation,
		Variables: map[string]interface{}{
			"repo_owner": repoOwner,
			"repo_name":  repoName,
		},
	...
	resp := &client.GQLResponse{
		Data: &PullRequestsWithMergeQueueResponse{},
	}
	...
	var data *PullRequestsWithMergeQueueResponse
	if resp.Data != nil {
		data = resp.Data.(*PullRequestsWithMergeQueueResponse)
	}
...
type ClosedOrphanPullRequestsViewer struct {
	Login        string
	PullRequests fezzik_types.PullRequestConnection
}

type ClosedOrphanPullRequestsRepository struct {
	Id string
}

// ClosedOrphanPullRequestsResponse response type for ClosedOrphanPullRequests
type ClosedOrphanPullRequestsResponse struct {
	Viewer     ClosedOrphanPullRequestsViewer
	Repository *ClosedOrphanPullRequestsRepository
}

// ClosedOrphanPullRequests from github/githubclient/queries.graphql:82
func (c *gqlclient) ClosedOrphanPullRequests(ctx context.Context,
	repoOwner string,
	repoName string,
) (*ClosedOrphanPullRequestsResponse, error) {

	var closedOrphanPullRequestsOperation string = `
	query ClosedOrphanPullRequests ($repo_owner: String!, $repo_name: String!) {
	viewer {
		login
...
`
	...
	gqlreq := &client.GQLRequest{
		OperationName: "ClosedOrphanPullRequests",
		Query:         closedOrphanPullRequestsOperation,
		Variables: map[string]interface{}{
			"repo_owner": repoOwner,
			"repo_name":  repoName,
		},
	...
	resp := &client.GQLResponse{
		Data: &ClosedOrphanPullRequestsResponse{},
	}
	...
	var data *ClosedOrphanPullRequestsResponse
	if resp.Data != nil {
		data = resp.Data.(*ClosedOrphanPullRequestsResponse)
	}
...
// AssignableUsers from github/githubclient/queries.graphql:121
...
// CreatePullRequest from github/githubclient/queries.graphql:141
...
// UpdatePullRequest from github/githubclient/queries.graphql:155
...
// AddReviewers from github/githubclient/queries.graphql:167
...
// CommentPullRequest from github/githubclient/queries.graphql:179
...
// MergePullRequest from github/githubclient/queries.graphql:189
...
// AutoMergePullRequest from github/githubclient/queries.graphql:201
...
// ClosePullRequest from github/githubclient/queries.graphql:213
...
// StarCheck from github/githubclient/queries.graphql:225
...
// StarGetRepo from github/githubclient/queries.graphql:241
...
// StarAdd from github/githubclient/queries.graphql:250
